...
if(i.cursorActivityHandlers)for(;i.cursorActivityCalled<i.cursorActivityHandlers.length;)i.cursorActivityHandlers[i.cursorActivityCalled++].call(null,i.cm)}}while(r<t.length)}(t)}finally{or=null,function(e){for(var t=0;t<e.ops.length;t++)e.ops[t].cm.curOp=null
...
for(var a=0;a<t.length;a++)Qn(t[a])}(e)}(t)}}(t)}function $n(e){var t=e.cm,r=t.display
...
for(var n=0;n<t.length;++n)t[n].parent=this},iterN:function(e,t,r){for(var n=e+t;e<n;++e)if(r(this.lines[e]))return!0}},wo.prototype={chunkSize:function(){return this.size},removeInner:function(e,t){var r=this
this.size-=t
...
this.collapse(s),this.children=[new bo(s)],this.children[0].parent=this}},collapse:function(e){for(var t=0;t<this.children.length;++t)this.children[t].collapse(e)},insertInner:function(e,t,r){var n=this
this.size+=t.length,this.height+=r
for(var i=0;i<this.children.length;++i){var o=n.children[i],a=o.chunkSize()
if(e<=a){if(o.insertInner(e,t,r),o.lines&&o.lines.length>50){for(var l=o.lines.length%25+25,s=l;s<o.lines.length;){var u=new bo(o.lines.slice(s,s+=25))
...
o.atomic&&to(u.doc),lr(u,"markerAdded",u,o)}return o}So.prototype.clear=function(){var e=this
if(!this.explicitlyCleared){var t=this.doc.cm,r=t&&!t.curOp
if(r&&qn(t),ve(this,"clear")){var n=this.find()
n&&lr(this,"clear",n.from,n.to)}for(var i=null,o=null,a=0;a<this.lines.length;++a){var l=e.lines[a],s=St(l.markedSpans,e)
t&&!e.collapsed?fn(t,Ye(l),"text"):t&&(null!=s.to&&(o=Ye(l)),null!=s.from&&(i=Ye(l))),l.markedSpans=Lt(l.markedSpans,s),null==s.from&&e.collapsed&&!jt(e.doc,l)&&t&&Xe(l,rn(t.display))}if(t&&this.collapsed&&!t.options.lineWrapping)for(var u=0;u<this.lines.length;++u){var c=Ft(e.lines[u]),d=Gt(c)
d>t.display.maxLineLength&&(t.display.maxLine=c,t.display.maxLineLength=d,t.display.maxLineChanged=!0)}null!=i&&t&&this.collapsed&&dn(t,i,o+1),this.lines.length=0,this.explicitlyCleared=!0,this.atomic&&this.doc.cantEdit&&(this.doc.cantEdit=!1,t&&to(t.doc)),t&&lr(t,"markerCleared",t,this,i,o),r&&_n(t),this.parent&&this.parent.clear()}},So.prototype.find=function(e,t){var r,n
...
n.markers.push(l),l.parent=n}}}(n,Mo(this)),n},unlinkDoc:function(e){var t=this
if(e instanceof Sa&&(e=e.doc),this.linked)for(var r=0;r<this.linked.length;++r)if(t.linked[r].doc==e){t.linked.splice(r,1),e.unlinkDoc(t),No(Mo(t))
break}if(e.history==this.history){var n=[e.id]
Pi(e,(function(e){return n.push(e.id)}),!0),e.history=new Ei(null),e.history.done=Ui(this.history.done,n),e.history.undone=Ui(this.history.undone,n)}},iterLinkedDocs:function(e){Pi(this,e)},getMode:function(){return this.mode},getEditor:function(){return this.cm},splitLines:function(e){return this.lineSep?e.split(this.lineSep):We(e)},lineSeparator:function(){return this.lineSep||"\n"},setDirection:ri((function(e){var t
...
function g(t){var r=++p,a=un(e,t,!0,"rectangle"==n.unit)
if(a)if(0!=tt(a,d)){e.curOp.focus=D(),f(a)
var l=Nn(i,o);(a.line>=l.to||a.line<l.from)&&setTimeout(ei(e,(function(){p==r&&g(t)})),150)}else{var s=t.clientY<h.top?-20:t.clientY>h.bottom?20:0
s&&setTimeout(ei(e,(function(){p==r&&(i.scroller.scrollTop+=s,g(t))})),50)}}function m(t){e.state.selectingText=!1,p=1/0,t&&(be(t),i.input.focus()),he(i.wrapper.ownerDocument,"mousemove",v),he(i.wrapper.ownerDocument,"mouseup",y),o.history.lastSelOrigin=null}var v=ei(e,(function(e){0!==e.buttons&&Se(e)?g(e):m(e)})),y=ei(e,m)
e.state.selectingText=y,de(i.wrapper.ownerDocument,"mousemove",v),de(i.wrapper.ownerDocument,"mouseup",y)}(e,n,t,o)}(t,n,o,e):Ce(e)==r.scroller&&be(e):2==i?(n&&_i(t.doc,n),setTimeout((function(){return r.input.focus()}),20)):3==i&&(C?t.display.input.onContextMenu(e):Cn(t)))}}function ga(e,t,r){if("char"==r)return new Ci(t,t)
...
if(f){var h=e.findMarks(et(n,0),et(i+1,0),function(e){return function(t){return t.id==e}}(+f))
...
if(n==e||"string"==typeof e&&n.name==e)return t.splice(r,1),this.state.modeGen++,void dn(this)}})),indentLine:ti((function(e,t,r){"string"!=typeof t&&"number"!=typeof t&&(t=null==t?this.options.smartIndent?"smart":"prev":t?"add":"subtract"),Qe(this.doc,e)&&Ta(this,e,t,r)})),indentSelection:ti((function(e){for(var t=this,r=this.doc.sel.ranges,n=-1,i=0;i<r.length;i++){var o=r[i]
if(o.empty())o.head.line>n&&(Ta(t,o.head.line,e,!0),n=o.head.line,i==t.doc.sel.primIndex&&Wn(t))
else{var a=o.from(),l=o.to(),s=Math.max(n,a.line)
n=Math.min(t.lastLine(),l.line-(l.ch?0:1))+1
for(var u=s;u<n;++u)Ta(t,u,e)
var c=t.doc.sel.ranges
0==a.ch&&r.length==c.length&&c[i].from().ch>0&&Xi(t.doc,i,new Ci(a,c[i].to()),V)}}})),getTokenAt:function(e,t){return yt(this,e,t)},getLineTokens:function(e,t){return yt(this,et(e),t,!0)},getTokenTypeAt:function(e){e=lt(this.doc,e)
...
if(null!=n)return void(t.context=n)}else if(!L(e,t.localVars))return void(t.localVars=new O(e,t.localVars))
r.globalVars&&!L(e,t.globalVars)&&(t.globalVars=new O(e,t.globalVars))}function M(e,t){if(t){if(t.block){var r=M(e,t.prev)
return r?r==t.prev?t:new A(r,t.vars,!0):null}return L(e,t.vars)?t:new A(t.prev,new O(e,t.vars),!1)}return null}function N(e){return"public"==e||"private"==e||"protected"==e||"abstract"==e||"readonly"==e}function A(e,t,r){this.prev=e,this.vars=t,this.block=r}function O(e,t){this.name=e,this.next=t}var W=new O("this",new O("arguments",null))
function D(){k.state.context=new A(k.state.context,k.state.localVars,!1),k.state.localVars=W}function z(){k.state.context=new A(k.state.context,k.state.localVars,!0),k.state.localVars=null}function P(){k.state.localVars=k.state.context.vars,k.state.context=k.state.context.prev}function H(e,t){var r=function(){var r=k.state,n=r.indented
...
return r.lex=!0,r}function I(){var e=k.state
e.lexical.prev&&(")"==e.lexical.type&&(e.indented=e.lexical.indented),e.lexical=e.lexical.prev)}function E(e){return function t(r){return r==e?S():";"==e||"}"==r||")"==r||"]"==r?C():S(t)}}function F(e,t){return"var"==e?S(H("vardef",t),be,E(";"),I):"keyword a"==e?S(H("form"),V,F,I):"keyword b"==e?S(H("form"),F,I):"keyword d"==e?k.stream.match(/^\s*$/,!1)?S():S(H("stat"),G,E(";"),I):"debugger"==e?S(E(";")):"{"==e?S(H("}"),z,ae,I,P):";"==e?S():"if"==e?("else"==k.state.lexical.info&&k.state.cc[k.state.cc.length-1]==I&&k.state.cc.pop()(),S(H("form"),V,F,I,Le)):"function"==e?S(Ae):"for"==e?S(H("form"),Te,F,I):"class"==e||u&&"interface"==t?(k.marked="keyword",S(H("form","class"==e?e:t),Pe,I)):"variable"==e?u&&"declare"==t?(k.marked="keyword",S(F)):u&&("module"==t||"enum"==t||"type"==t)&&k.stream.match(/^\s*\w/,!1)?(k.marked="keyword","enum"==t?S(qe):"type"==t?S(We,E("operator"),de,E(";")):S(H("form"),we,E("{"),H("}"),ae,I,I)):u&&"namespace"==t?(k.marked="keyword",S(H("form"),B,F,I)):u&&"abstract"==t?(k.marked="keyword",S(F)):S(H("stat"),J):"switch"==e?S(H("form"),V,E("{"),H("}","switch"),z,ae,I,I,P):"case"==e?S(B,E(":")):"default"==e?S(E(":")):"catch"==e?S(H("form"),D,R,F,I,P):"export"==e?S(H("stat"),Fe,I):"import"==e?S(H("stat"),Be,I):"async"==e?S(F):"@"==t?S(B,F):C(H("stat"),B,E(";"),I)}function R(e){if("("==e)return S(De,E(")"))}function B(e,t){return K(e,t,!1)}function j(e,t){return K(e,t,!0)}function V(e){return"("!=e?C():S(H(")"),B,E(")"),I)}function K(e,t,r){if(k.state.fatArrowAt==k.stream.start){var n=r?Y:X
if("("==e)return S(D,H(")"),ie(De,")"),I,E("=>"),n,P)
if("variable"==e)return C(D,we,E("=>"),n,P)}var i=r?q:U
return b.hasOwnProperty(e)?S(i):"function"==e?S(Ae,i):"class"==e||u&&"interface"==t?(k.marked="keyword",S(H("form"),ze,I)):"keyword c"==e||"async"==e?S(r?j:B):"("==e?S(H(")"),G,E(")"),I,i):"operator"==e||"spread"==e?S(r?j:B):"["==e?S(H("]"),Ue,I,i):"{"==e?oe(te,"}",null,i):"quasi"==e?C(_,i):"new"==e?S(function(e){return function(t){return"."==t?S(e?Q:Z):"variable"==t&&u?S(me,e?q:U):C(e?j:B)}}(r)):"import"==e?S(B):S()}function G(e){return e.match(/[;\}\)\],]/)?C():C(B)}function U(e,t){return","==e?S(B):q(e,t,!1)}function q(e,t,r){var n=0==r?U:q,i=0==r?B:j
return"=>"==e?S(D,r?Y:X,P):"operator"==e?/\+\+|--/.test(t)||u&&"!"==t?S(n):u&&"<"==t&&k.stream.match(/^([^>]|<.*?>)*>\s*\(/,!1)?S(H(">"),ie(de,">"),I,n):"?"==t?S(B,E(":"),i):S(i):"quasi"==e?C(_,n):";"!=e?"("==e?oe(j,")","call",n):"."==e?S(ee,n):"["==e?S(H("]"),G,E("]"),I,n):u&&"as"==t?(k.marked="keyword",S(de,n)):"regexp"==e?(k.state.lastType=k.marked="operator",k.stream.backUp(k.stream.pos-k.stream.start-1),S(i)):void 0:void 0}function _(e,t){return"quasi"!=e?C():"${"!=t.slice(t.length-2)?S(_):S(B,$)}function $(e){if("}"==e)return k.marked="string-2",k.state.tokenize=v,S(_)}function X(e){return y(k.stream,k.state),C("{"==e?F:B)}function Y(e){return y(k.stream,k.state),C("{"==e?F:j)}function Z(e,t){if("target"==t)return k.marked="keyword",S(U)}function Q(e,t){if("target"==t)return k.marked="keyword",S(q)}function J(e){return":"==e?S(I,F):C(U,E(";"),I)}function ee(e){if("variable"==e)return k.marked="property",S()}function te(e,t){return"async"==e?(k.marked="property",S(te)):"variable"==e||"keyword"==k.style?(k.marked="property","get"==t||"set"==t?S(re):(u&&k.state.fatArrowAt==k.stream.start&&(r=k.stream.match(/^\s*:\s*/,!1))&&(k.state.fatArrowAt=k.stream.pos+r[0].length),S(ne))):"number"==e||"string"==e?(k.marked=l?"property":k.style+" property",S(ne)):"jsonld-keyword"==e?S(ne):u&&N(t)?(k.marked="keyword",S(te)):"["==e?S(B,le,E("]"),ne):"spread"==e?S(j,ne):"*"==t?(k.marked="keyword",S(te)):":"==e?C(ne):void 0
var r}function re(e){return"variable"!=e?C(ne):(k.marked="property",S(Ae))}function ne(e){return":"==e?S(j):"("==e?C(Ae):void 0}function ie(e,t,r){function n(i,o){if(r?r.indexOf(i)>-1:","==i){var a=k.state.lexical
return"call"==a.info&&(a.pos=(a.pos||0)+1),S((function(r,n){return r==t||n==t?C():C(e)}),n)}return i==t||o==t?S():r&&r.indexOf(";")>-1?C(e):S(E(t))}return function(r,i){return r==t||i==t?S():C(e,n)}}function oe(e,t,r){for(var n=3;n<arguments.length;n++)k.cc.push(arguments[n])
return S(H(t,r),ie(e,t),I)}function ae(e){return"}"==e?S():C(F,ae)}function le(e,t){if(u){if(":"==e)return S(de)
if("?"==t)return S(le)}}function se(e,t){if(u&&(":"==e||"in"==t))return S(de)}function ue(e){if(u&&":"==e)return k.stream.match(/^\s*\w+\s+is\b/,!1)?S(B,ce,de):S(de)}function ce(e,t){if("is"==t)return k.marked="keyword",S()}function de(e,t){return"keyof"==t||"typeof"==t||"infer"==t?(k.marked="keyword",S("typeof"==t?j:de)):"variable"==e||"void"==t?(k.marked="type",S(ge)):"|"==t||"&"==t?S(de):"string"==e||"number"==e||"atom"==e?S(ge):"["==e?S(H("]"),ie(de,"]",","),I,ge):"{"==e?S(H("}"),ie(he,"}",",;"),I,ge):"("==e?S(ie(pe,")"),fe,ge):"<"==e?S(ie(de,">"),de):void 0}function fe(e){if("=>"==e)return S(de)}function he(e,t){return"variable"==e||"keyword"==k.style?(k.marked="property",S(he)):"?"==t||"number"==e||"string"==e?S(he):":"==e?S(de):"["==e?S(E("variable"),se,E("]"),he):"("==e?C(Oe,he):void 0}function pe(e,t){return"variable"==e&&k.stream.match(/^\s*[?:]/,!1)||"?"==t?S(pe):":"==e?S(de):"spread"==e?S(pe):C(de)}function ge(e,t){return"<"==t?S(H(">"),ie(de,">"),I,ge):"|"==t||"."==e||"&"==t?S(de):"["==e?S(de,E("]"),ge):"extends"==t||"implements"==t?(k.marked="keyword",S(de)):"?"==t?S(de,E(":"),de):void 0}function me(e,t){if("<"==t)return S(H(">"),ie(de,">"),I,ge)}function ve(){return C(de,ye)}function ye(e,t){if("="==t)return S(de)}function be(e,t){return"enum"==t?(k.marked="keyword",S(qe)):C(we,le,Ce,Se)}function we(e,t){return u&&N(t)?(k.marked="keyword",S(we)):"variable"==e?(T(t),S()):"spread"==e?S(we):"["==e?oe(ke,"]"):"{"==e?oe(xe,"}"):void 0}function xe(e,t){return"variable"!=e||k.stream.match(/^\s*:/,!1)?("variable"==e&&(k.marked="property"),"spread"==e?S(we):"}"==e?C():"["==e?S(B,E("]"),E(":"),xe):S(E(":"),we,Ce)):(T(t),S(Ce))}function ke(){return C(we,Ce)}function Ce(e,t){if("="==t)return S(j)}function Se(e){if(","==e)return S(be)}function Le(e,t){if("keyword b"==e&&"else"==t)return S(H("form","else"),F,I)}function Te(e,t){return"await"==t?S(Te):"("==e?S(H(")"),Me,I):void 0}function Me(e){return"var"==e?S(be,Ne):"variable"==e?S(Ne):C(Ne)}function Ne(e,t){return")"==e?S():";"==e?S(Ne):"in"==t||"of"==t?(k.marked="keyword",S(B,Ne)):C(B,Ne)}function Ae(e,t){return"*"==t?(k.marked="keyword",S(Ae)):"variable"==e?(T(t),S(Ae)):"("==e?S(D,H(")"),ie(De,")"),I,ue,F,P):u&&"<"==t?S(H(">"),ie(ve,">"),I,Ae):void 0}function Oe(e,t){return"*"==t?(k.marked="keyword",S(Oe)):"variable"==e?(T(t),S(Oe)):"("==e?S(D,H(")"),ie(De,")"),I,ue,P):u&&"<"==t?S(H(">"),ie(ve,">"),I,Oe):void 0}function We(e,t){return"keyword"==e||"variable"==e?(k.marked="type",S(We)):"<"==t?S(H(">"),ie(ve,">"),I):void 0}function De(e,t){return"@"==t&&S(B,De),"spread"==e?S(De):u&&N(t)?(k.marked="keyword",S(De)):u&&"this"==e?S(le,Ce):C(we,le,Ce)}function ze(e,t){return"variable"==e?Pe(e,t):He(e,t)}function Pe(e,t){if("variable"==e)return T(t),S(He)}function He(e,t){return"<"==t?S(H(">"),ie(ve,">"),I,He):"extends"==t||"implements"==t||u&&","==e?("implements"==t&&(k.marked="keyword"),S(u?de:B,He)):"{"==e?S(H("}"),Ie,I):void 0}function Ie(e,t){return"async"==e||"variable"==e&&("static"==t||"get"==t||"set"==t||u&&N(t))&&k.stream.match(/^\s+[\w$\xa1-\uffff]/,!1)?(k.marked="keyword",S(Ie)):"variable"==e||"keyword"==k.style?(k.marked="property",S(u?Ee:Ae,Ie)):"number"==e||"string"==e?S(u?Ee:Ae,Ie):"["==e?S(B,le,E("]"),u?Ee:Ae,Ie):"*"==t?(k.marked="keyword",S(Ie)):u&&"("==e?C(Oe,Ie):";"==e||","==e?S(Ie):"}"==e?S():"@"==t?S(B,Ie):void 0}function Ee(e,t){if("?"==t)return S(Ee)
if(":"==e)return S(de,Ce)
if("="==t)return S(j)
var r=k.state.lexical.prev
return C(r&&"interface"==r.info?Oe:Ae)}function Fe(e,t){return"*"==t?(k.marked="keyword",S(Ge,E(";"))):"default"==t?(k.marked="keyword",S(B,E(";"))):"{"==e?S(ie(Re,"}"),Ge,E(";")):C(F)}function Re(e,t){return"as"==t?(k.marked="keyword",S(E("variable"))):"variable"==e?C(j,Re):void 0}function Be(e){return"string"==e?S():"("==e?C(B):C(je,Ve,Ge)}function je(e,t){return"{"==e?oe(je,"}"):("variable"==e&&T(t),"*"==t&&(k.marked="keyword"),S(Ke))}function Ve(e){if(","==e)return S(je,Ve)}function Ke(e,t){if("as"==t)return k.marked="keyword",S(je)}function Ge(e,t){if("from"==t)return k.marked="keyword",S(B)}function Ue(e){return"]"==e?S():C(ie(j,"]"))}function qe(){return C(H("form"),we,E("{"),H("}"),ie(_e,"}"),I,I)}function _e(){return C(we,Ce)}function $e(e,t,r){return t.tokenize==g&&/^(?:operator|sof|keyword [bcd]|case|new|export|default|spread|[\[{}\(,;:]|=>)$/.test(t.lastType)||"quasi"==t.lastType&&/\{\s*$/.test(e.string.slice(0,e.pos-(r||0)))}return P.lex=!0,I.lex=!0,{startState:function(e){var t={tokenize:g,lastType:"sof",cc:[],lexical:new w((e||0)-o,0,"block",!1),localVars:r.localVars,context:r.localVars&&new A(null,null,!1),indented:e||0}
...
for(k.state=e,k.stream=i,k.marked=null,k.cc=o,k.style=t,e.lexical.hasOwnProperty("align")||(e.lexical.align=!0);;)if((o.length?o.pop():s?B:F)(r,n)){for(;o.length&&o[o.length-1].lex;)o.pop()()
...
if(c==I)s=s.prev
else if(c!=Le)break}for(;("stat"==s.type||"form"==s.type)&&("}"==l||(i=t.cc[t.cc.length-1])&&(i==U||i==q)&&!/^[,\.=+\-*:?[\(]/.test(n));)s=s.prev
...
//# sourceMappingURL=codemirror-0bb6ad9e5932e66cef2a680d7dc42fa4.map