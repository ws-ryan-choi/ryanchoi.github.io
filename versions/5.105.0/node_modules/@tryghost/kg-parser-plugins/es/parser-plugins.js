...
function fromKoenigCard$7() {
  return function kgAudioCardToCard(node, builder, {
    addSection,
    nodeFinished
  }) {
...
function fromKoenigCard$6() {
  return function kgButtonCardToCard(node, builder, {
    addSection,
    nodeFinished
  }) {
...
function fromWordpressButton() {
  return function wordpressButtonToCard(node, builder, {
    addSection,
    nodeFinished
  }) {
...
function fromSubstackButton() {
  return function substackButtonToCard(node, builder, {
    addSection,
    nodeFinished
  }) {
    ...
    const payload = {
      alignment: 'center',
      // all Substack buttons are centered
      buttonUrl,
      buttonText
    };
    const cardSection = builder.createCardSection('button', payload);
...
function addFigCaptionToPayload(node, payload, {
  selector = 'figcaption',
  options
}) {
...
function fromMixtape(options) {
  return function mixtapeEmbed(node, builder, {
    addSection,
    nodeFinished
  }) {
...
function fromFigureIframe(options) {
  return function figureIframeToEmbed(node, builder, {
    addSection,
    nodeFinished
  }) {
...
function fromIframe() {
  return function iframeToEmbedCard(node, builder, {
    addSection,
    nodeFinished
  }) {
...
function fromFigureBlockquote(options) {
  return function figureBlockquoteToEmbedCard(node, builder, {
    addSection,
    nodeFinished
  }) {
    if (node.nodeType !== 1 || node.tagName !== 'FIGURE') {
...
function fromNFTEmbed() {
  return function fromNFTEmbedToEmbedCard(node, builder, {
    addSection,
    nodeFinished
  }) {
...
function fromKoenigCard$5() {
  return function kgFileCardToCard(node, builder, {
    addSection,
    nodeFinished
  }) {
...
function fromKoenigCard$4() {
  return function kgHeaderCardToCard(node, builder, {
    addSection,
    nodeFinished
  }) {
...
function fromKoenigCard$3() {
  return function kgHtmlCardToCard(node, builder, {
    addSection,
    nodeFinished
  }) {
...
function fromImg() {
  return function imgToCard(node, builder, {
    addSection,
    nodeFinished
  }) {
...
function fromFigure(options) {
  return function figureImgToCard(node, builder, {
    addSection,
    nodeFinished
  }) {
    if (node.nodeType !== 1 || node.tagName !== 'FIGURE') {
...
function fromBr() {
  ...
  return function fromBrToSoftReturnAtom(node, builder, {
    addMarkerable,
    nodeFinished
  }) {
...
function fromKoenigCard$1() {
  return function kgVideoCardToCard(node, builder, {
    addSection,
    nodeFinished
  }) {
...
function fromKoenigCard(options) {
  return function kgGalleryCardToCard(node, builder, {
    addSection,
    nodeFinished
  }) {
    if (node.nodeType !== 1 || node.tagName !== 'FIGURE') {
...
function fromGrafGallery(options) {
  return function grafGalleryToCard(node, builder, {
    addSection,
    nodeFinished
  }) {
...
function fromSqsGallery(options) {
  return function sqsGalleriesToCard(node, builder, {
    addSection,
    nodeFinished
  }) {
...
function createParserPlugins(_options = {}) {
  ...
  function kgCalloutCardToCard(node, builder, {
    addSection,
    nodeFinished
  }) {
  ...
  function kgToggleCardToCard(node, builder, {
    addSection,
    nodeFinished
  }) {
  ...
  function tableToHtmlCard(node, builder, {
    addSection,
    nodeFinished
  }) {
