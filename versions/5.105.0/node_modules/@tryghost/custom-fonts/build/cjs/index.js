...
function isValidCustomFont(fontName) {
    return exports.CUSTOM_FONTS.body.some(font => font.name === fontName);
}
function isValidCustomHeadingFont(fontName) {
    return exports.CUSTOM_FONTS.heading.some(font => font.name === fontName);
}
